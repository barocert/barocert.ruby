...
class BaseServiceTest < Test::Unit::TestCase
	...
	# 		"reqMessage" => BaseServiceTest::PasscertInstance._encrypt('본인인증 요청 메시지'),
	# 		"callCenterNum" => '1600-9854',
	# 		"expireIn" => 1000,
	# 		"token" => BaseServiceTest::PasscertInstance._encrypt('본인인증 요청 원문'),
	...
	# 		"reqMessage" => BaseServiceTest::PasscertInstance._encrypt('출금동의 요청 메시지'),
	# 		"callCenterNum" => '1600-9854',
	# 		"expireIn" => 1000,
	# 		'userAgreementYN' => true,
	# 		'receiverInfoYN' => true,
	...
	# 		"reqMessage" => BaseServiceTest::PasscertInstance._encrypt('간편로그인 요청 메시지'),
	# 		"callCenterNum" => '1600-9854',
	# 		"expireIn" => 1000,
	# 		"token" => BaseServiceTest::PasscertInstance._encrypt('간편로그인 요청 원문'),
	# 		'userAgreementYN' => true,
	# 		'receiverInfoYN' => true,
	# 		'appUseYN' => false,
	# 		#'telcoType' => 'SKT',
